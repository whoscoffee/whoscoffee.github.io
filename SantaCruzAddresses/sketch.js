...
//parses address data into a more usuable 2d array
function parse(){
    for (let i = 0; i < result.length;i++)
        result[i] = result[i].split("\t");
}
//gets all addresses within x,y lat and lon given dist in KM
...
//sorts addresses in accending order(bubblesort)
...
//finds an address with given text from text box
function find(){
    print(this.value());
